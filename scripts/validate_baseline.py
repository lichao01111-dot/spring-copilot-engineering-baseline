...
REQUIRED_FILES = [
    ...
    ".editorconfig", "templates/task-state.yaml", "templates/adr.md", "templates/review-report.md", "templates/goal.md", "templates/migration-plan.md", "templates/release-checklist.md", "templates/service-boundary.md", "standards/service-boundary-and-deployment.md", "standards/java-readability-and-conventions.md", "standards/java-tooling-integration.md", "scripts/scan_secrets.py",
]
